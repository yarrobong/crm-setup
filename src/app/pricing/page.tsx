...
export const metadata: Metadata = {
  title: 'Цены на внедрение CRM | Автоматизация бизнеса',
  description: 'Прозрачные цены на настройку CRM, автоматизацию продаж и бизнес-процессов. Оплата за результат.',
};
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {PRICING.map((plan, index) => (
          <Card key={index} className={plan.popular ? 'border-primary shadow-lg scale-100 md:scale-105 z-10 relative' : ''}>
            {plan.popular && (
